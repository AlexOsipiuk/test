...
public class UsersDao implements IUsersDao {
   // private static Logger logger=Logger.getLogger(BookWriterDAOImpl.class);
    ...
    @Override
    public List<UsersKart> getUsersKartByUserId(int id, Connection connection) {
        return null;
    }

    @Override
    public Users getUserInfoByName(String name, Connection connection) {
        return null;
    }

    @Override
    public String getUserInfoByEmail(String email, Connection connection) {
        return null;
    }
}